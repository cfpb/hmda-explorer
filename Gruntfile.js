    ...
    copy: {
      dist: {
        files: [
          ...
          {expand: true, cwd: 'src/static/vendor/cfpb-font-icons/assets/fonts/', src: ['**'], dest: 'dist/static/fonts/'},
          {expand: true, cwd: 'src/static/vendor/cfpb-font-icons/assets/css/', src: ['icons-ie7.css'], dest: 'dist/static/css/'},
