var chart2_options = {
    ...
    series: [
        { 
            name: 'Conventional',
            data: [62.430214077318546,63.736019620134456,60.95191810341459]
        },
        {
            name: 'FHA',
            data: [23.64733578575852,21.244614839331266,25.291430768100838]
        },
        {
            name: 'VA',
            data: [9.090600446212047,10.257496436041656,10.150157283073591]

        },
        {
            name: 'RHS/FSA',
            data: [4.83184969071088,4.76186910449262,3.6064938454109754]
        },
    ]
};
