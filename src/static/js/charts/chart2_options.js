var chart2_options = {
    ...
    series: [
        { 
            name: 'Conventional',
            data: [62.430214077318546,63.72718822872299,62.217071916529]
        },
        {
            name: 'FHA',
            data: [23.64733578575852,21.249374934461745,24.369001154313153]
        },
        {
            name: 'VA',
            data: [9.090600446212047,10.260276933458787,9.74791440234572]

        },
        {
            name: 'RHS/FSA',
            data: [4.83184969071088,4.763159903356486,3.6660125268121275]
        },
    ]
};
