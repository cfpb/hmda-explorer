var chart2_options = {
    ...
    series: [
        { 
            name: 'Conventional',
            data: [62.430214077318546,63.72718822872299,60.95191810341459]
        },
        {
            name: 'FHA',
            data: [23.64733578575852,21.249374934461745,25.291430768100838]
        },
        {
            name: 'VA',
            data: [9.090600446212047,10.260276933458787,10.150157283073591]

        },
        {
            name: 'RHS/FSA',
            data: [4.83184969071088,4.763159903356486,3.6064938454109754]
        },
    ]
};
