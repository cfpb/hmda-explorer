var chart2_options = {
    ...
    series: [
        { 
            name: 'Conventional',
            data: [55.29683030237278,62.430214077318546,63.72718822872299]
        },
        {
            name: 'FHA',
            data: [30.503188479877046,23.64733578575852,21.249374934461745]
        },
        {
            name: 'VA',
            data: [8.904758984712192,9.090600446212047,10.260276933458787]

        },
        {
            name: 'RHS/FSA',
            data: [5.295222233037977,4.83184969071088,4.763159903356486]
        },
    ]
};
