...
* public-data-platform-static - v0.1.0 - 2013-07-10
...
var PDP = PDP || function() {
    "use strict";
    var observer = new EventEmitter(), app = {}, query = {}, form = {}, preview = {};
    app.$el = $("#filters");
    app.init = function() {
    ...
    query.updateAll = function() {
        var $fields = app.$el.find(".param"), url;
        observer.emitEvent("update:started");
        this.reset();
        $fields.each(function() {
            var $this = $(this), field = form.getField($this);
    ...
    form.getField = function($el) {
        var tagName = $el.prop("tagName").toLowerCase(), type = $el.attr("type"), name = $el.attr("name") || "untitled", value = $el.val(), field = {};
    ...
    form.fetchFieldOptions = function(id) {
        var endpoint = "/static/js/data/", promise = $.ajax(endpoint + "options.json");
        return promise;
    };
    form.checkDeps = function(el) {
        var $el = $(el), dependents = $el.attr("data-dependent").split(" ").join(", #"), $dependents;
        if (dependents) {
    ...
    observer.addListeners({
        ...
        "app:ready": [ app.start.bind(app), app.stopLoading.bind(app) ],
        "filter:changed": [ query.updateAll.bind(query), form.checkDeps.bind(form) ],
