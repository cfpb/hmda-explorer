$(document).ready(function() {
    ...
    var chart1DataObj = {
        'msa01': {
            name: 'U.S. Total',
            data: [
                [3358121, 3117454, 3448970],
                [2213631, 2060808, 2331989],
                [245034, 235335, 270879],
                [142357, 136967, 169193],
                [7609156, 6560190, 9264878],
                [4509310, 3840044, 5900788]
            ]
        },
        'msa02': {
            name: 'Total, all counties not part of any MSA',
            data: [
                [596622, 546379, 589303],
                [304938, 290253, 325131],
                [60768, 58915, 67270],
                [36306, 35506, 43420],
                [1189800, 1022617, 1305309],
                [679482, 578242, 806149]
            ]
        },
        'msa03': {
            name: 'Abilene - TX',
        ...
        'msa66': {
            ...
            data: [
                ...
                [4073, 4885, 3861],
                [2276, 2597, 2247],
                [252468, 210212, 275087],
                [162880, 131745, 183436]
            ]
        },
        'msa67': {
            name: 'Chico - CA',
        ...
        'msa203': {
            ...
            data: [
                ...
                [5719, 6700, 6186],
                [3357, 3785, 4050],
                [210565, 200072, 302299],
                [125254, 119496, 192385]
            ]
        },
        'msa204': {
